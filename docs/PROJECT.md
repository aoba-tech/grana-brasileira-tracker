...
3. **Mapping**: Map to internal transaction format and require an account
4. **Import**: Save to database with category assignment

> A preview and duplicate detection are not implemented yet; see `HANDOFF.md`.
